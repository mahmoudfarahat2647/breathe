 ...
 * `/?variant=mockup`. Starts as a structural copy of breathe-app.tsx using the
 * SAME real engine hook and child components; the restyle is built out inside
 * this file and inside the `.breathe-root.mockup-variant` CSS block in
 * globals.css, so production styling and the production screen stay untouched
 * during convergence.
 *
 * Throwaway: once a direction is approved it is folded into breathe-app.tsx /
 * globals.css and this file, src/app/mockup-variant-controller.tsx,
 * src/presentation/mockup-switcher.tsx, src/presentation/mockup-fixture.ts, and
 * the scoped CSS block are all deleted.
 */
...
export function BreatheAppMockup({
  ...
  return (
    <div className={`breathe-root mockup-variant ${engine.view.phaseClass}`}>
